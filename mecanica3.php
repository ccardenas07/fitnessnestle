...
//                                            $_SESSION['image'] = 'https://graph.facebook.com/'.$value.'/picture';
                                  ...
                                  echo 'test';
                                    ?>
                                   <!--  <iframe src="https://www.appiglu.com/apps.facebook/nestle/fitnessnestle/mecanica.php" width="790" height="1000" frameborder="0"/>
...
<img src="https://www.appiglu.com/apps.facebook/nestle/fitnessnestle/image/Btn_empezar.png" width="229px" height="46px" />
</a>
</div>
<br />
<center><h2>Este es una app de prueba. No se encuentra al aire</h2></center>
<div class="terminos">
<a href="terminos.php"target="_blank" onClick="window.open(this.href, this.target, 'width=300,height=200'); return false;">
